...
function makeChart(housebitcoin) {
  ...
  var rangeOne = housebitcoin.map(function(d) {return (d.Price_eum2*100/d.BTCEUR_year_ave)}).slice(rangeStart, rangeEnd);
  var rangeTwo = housebitcoin.map(function(d) { return (d.Price_eum2*100)}).slice(rangeStart, rangeEnd);
        ...
        tooltip: {
          callbacks: {
            label(ctx) {
                  ...
                  } else if (label === 'Price in bitcoin (₿)') {
                    // two decimals
