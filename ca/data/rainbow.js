    ...
    options: {
      scales: {
        ...
        y: {
          title: {
                  display: true,
                  text: 'Preu en euros, ajustat a inflació',
                  font: {
                    size: 10
                  },
              },
      ...
      plugins: {
        title: {
                display: true,
                text: 'Cicles del preu - Habitatge a Espanya',
                color: "white",
                font: {
                  size: 12
                },
