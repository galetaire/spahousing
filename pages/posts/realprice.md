...
[^1]: If the price index is in decimal form, the expression would be the following:

![Equation](https://math.vercel.app?from=Real\:value\:_{t}=\frac{Nominal\:value\:_{t}}{Price\:index\:(decimal form)\:_{t}})
