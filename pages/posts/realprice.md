...
Where _t_ means the reference year, and where we use the year 1985 as the base year (100) for the price index (CPI). Let's see a basic example for the year(_t_) 1987:
