...
- **Observation E**: About the ratio (third chart). If the ratio is **greater than 1**, there are more mortgages than home sales, indicating the danger of a credit bubble. If it is **less than 1**, there are more home sales than mortgages, indicating that cash purchases are gaining strength.
