...
The population data is properly documented by the INE from 1964 onwards, but in order to approximate the population growth between 1900 and 1963, the reference data used has been also the historical series provided by the INE (_Instituto Nacional de Estadística_). Link source:
...
The data presented by _Roser Nicolau_ uses the mentioned historical data by the INE too, but does a deeper sourcing work in trying to provide better accuracy on the Spanish demography. Link source:
...
| ---- | ----------------------- | -------------- |
| 1970 | No data | 10.659.882 |
| 1981 | 14.860.272 | 14.726.000 |
| 1991 | 17.336.208 | 17.206.000 |
| 2001 | 21.025.227 | 21.033.759 |
...
| ---- | ------------------------- | -------------- |
| 1900 | 1.879.400 | 2.900.608 |
| 1910 | 2.023.600 | 3.283.754 |
| 1920 | 2.243.000 | 3.704.853 |
| 1930 | 2.644.700 | 4.261.352 |
| 1940 | 3.106.400 | 5.003.585 |
| 1950 | 6.287.490 | 6.003.353 |
...
Based on this data, between 1900 and 1920, 61% of houses were in urban areas, while 39% were in rural areas. Running the numbers, if there were 1.8 million urban houses in 1900, and these represented 61% of the total stock, then the total would be around 2.9 million houses. Since 2.9 million falls into our considered range, we have assumed this value to be the best approximation we could get.

Then, having 2.9 million houses in 1900 as our starting point, one of the last variables we considered for our estimations was the number of people employed in the construction sector, from the historical research conducted by _Leandro Prados de la Escosura (2017_), found in:
...
| Year | Employed in construction | Workers needed per home | Inhabitants per home |
| ---- | ------------------------- | -------------- | ------------------------ |
| 1970 | - | - | 3,17 |
| 1980 | - | - | 2,59 |
...
The best proxy we identified is linked to demography, particularly the number of inhabitants and the fertility rate. As shown in the previous table, the number of inhabitants per home has been steadily decreasing over the last 50 years (source: INE). It is reasonable to assume that the number of inhabitants per home would have been higher the further back in time we go.
...
After several iterations, we determined that the most suitable estimate for the number of inhabitants per house in 1900 is approximately 6 inhabitants per home. This choice exhibited a smooth downtrend that aligned well with historical data until connecting with current data.
...
| ---- | ------------------------- | -------------- | ------------------------ |
| 1900 | 297.294 | 8,0 (est.) | 6,42 (est.) |
| 1910 | 311.753 | 8,0 (est.) | 6,09 (est.) |
| 1920 | 339.384 | 7,6 (est.) | 5,78 (est.) |
| 1930 | 482.369 | 7,2 (est.) | 5,56 (est.) |
| 1940 | 505.798 | 6,6 (est.) | 5,08 (est.) |
| 1950 | 758.773 | 6,1 (est.) | 4,66 (est.) |
| 1960 | 904.864 | 4,1 (est.) | 4,01 (est.) |
| 1970 | 1.285.694 | 3,5 (est.) | 3,17 |
