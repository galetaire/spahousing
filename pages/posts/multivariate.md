...
The model groups together seven essential variables: price (real and nominal), volume, inflation, credit, demographics and employment. A couple of observations from the chart:
