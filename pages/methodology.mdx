...
| **Channel** | **Address** |
| ---------- | ------------------------------------------ |
| <Image src="/images/bac.png" alt="Reload image" width={150} height={150} /> | Additionally, you can subscribe to my substack newsletter, [_Bricks and Charts_](https://spanishrealestate.substack.com/),
where I deliver quarterly reports and an overview of the Spanish housing market using website data. |
