...
The statistical information presented on this website refers to Spain. Similar data for [Catalonia](http://catalanhousing.galetaire.hns.is) and the [Balearic Islands](http://balears.galetaire.hns.is) is
also available.
