...
Note that the last update reflects when I last checked for new data availability, which won't match with the data in the chart, since data lags some time behind the current date.
