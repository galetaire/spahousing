...
| **File format** | **Access**|
| ----- | ----- |
| .csv - Comma Separated Values| _Coming soon_ |
| .xml - Extensible Markup Language | _Coming soon_ |
| .ods - OpenDocument Spreadsheet   | _Coming soon_ |
| .xls - Microsoft Excel worksheets | _Coming soon_ |
