...
As a rule of thumb, the datum is updated quarterly. In any case, the last update date can be consulted in the header of each indicator post. Note that displayed data will always lag some time behind the current date.
