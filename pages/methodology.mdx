...
When dealing with current year data, the data is an annual projection using the available months, without seasonal adjustments, not relevant for the sector.
...
Consider that the publication date reflects the last date when I revised data availability and probably will not match necessarily with the date of the data in the chart, since official data usually lags some time behind the current date.
