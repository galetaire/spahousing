...
The statistical information presented on this website refers to Spain. Same data for Catalonia and the Balearic Islands can be seen on
the following handshake addresses: [catalanhousing.galetaire/](http://catalanhousing.galetaire.hns.is) and [balears.galetaire/](http://balears.galetaire.hns.is).

| **Newsletter** | **Bricks and Charts** |
| ---------- | ------------------------------------------ |
| <Image src="/images/bac.png" width={150} height={150} /> | Additionally, you can subscribe to my substack newsletter, [_Bricks and Charts_](https://spanishrealestate.substack.com/), where I deliver quarterly reports and an overview of the Spanish housing market using data published on this site. |
