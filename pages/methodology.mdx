...
This website has been built using [Github](https://github.com/), [Vercel](https://vercel.com) and [Next.js](https://nextjs.org/). A mirrored website can be acces in the following [Handshake](https://handshake.org/) adress -> ```http://spain.galetaire```.
