...
Note that the publication date reflects when I last checked for new data availability, which won't match with the data in the chart, since data usually lags some time behind the current date.
