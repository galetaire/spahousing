...
The statistical information presented on this website refers to Spain (map, zone 2), but you can see the same data for Catalonia
(map, zone 1) on [catalanhousing.xyz](https://catalanhousing.xyz). Data from other Spanish regions are available upon request.
