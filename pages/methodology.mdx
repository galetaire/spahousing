...
The production of the charts is based on data from multiple contrasted statistical institutions. The charts are reproducible and can be verified by consulting the sources in each indicator entry. The following is a summary of all used sources:
