...
| ---------- | ------------------------------------------ |
| <Image src="/images/bac.png" width={150} height={150} /> | Additionally, you can subscribe to my substack newsletter, [_Bricks and Charts_](https://bricksandcharts.substack.com/), where I deliver quarterly reports and an overview of the Spanish housing market using data published on this site. |
