...
The production of the charts is based on data from multiple contrasted statistical institutions. All are reproducible and can be verified by consulting the sources in each indicator post. Summary of all used sources:
