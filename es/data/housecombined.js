...
function makeChart(rows) {
  ...
  var RIGHT = {
    dollar: {
      buttonText: 'Dólar ($)', color: C_USD,
      label: 'Precio en USD ($)', data: seriesUsd,
    ...
    gold: {
      buttonText: 'Oro (Au)', color: C_GOLD,
      label: 'Precio en onzas de oro (Au)', data: seriesGold,
    ...
    bitcoin: {
      ...
      label: 'Precio en bitcoins (₿)', data: seriesBtc,
  ...
  caption.textContent = 'Comparar € con:';
  ...
  function render() {
    ...
    chart = new Chart(canvas, {
      ...
      data: {
        labels: rangeLabels,
        datasets: [
          line('Precio en Euros (€)', seriesEur, C_EUR, 'yFiat'),
