...
function makeChart(employed100) {
  ...
  new Chart('employed100', {
    ...
    data: {
      ...
      datasets: [
        {
          label: 'Trabajadores en el sector de la construcción por cada 100 habitantes',
          type: 'bar',
          data: rangeOne,
    ...
    tooltip: {
      callbacks: {
        label(ctx) {
                  ...
                  } else if (label === 'Trabajadores en el sector de la construcción por cada 100 habitantes') {
                    // two decimals
