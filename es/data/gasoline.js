function makeChart(gasoline) {
  ...
  var chart = new Chart('gasoline', {
    ...
    data: {
      ...
      datasets: [
        {
          label: "Precio de la gasolina en España, USD por litros",
          data: rangeOne,
        ...
        {
          label: "Precio de la gasolina en EEUU, USD por litros",
          data: rangeTwo,
        ...
        tooltip: {
          callbacks: {
            label(ctx) {
                      ...
                      } else if (label === 'Precio de la gasolina en España, USD por litros' ||
                                label === 'Precio de la gasolina en EEUU, USD por litros') {
                        // two decimals
